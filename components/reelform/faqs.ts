export const faqs = [
  ...
  [
    "What can I create?",
    "Try a new outfit, a dream destination, a supercar, a private yacht, or a luxury villa. Use footage and references you have permission to use, and label realistic AI edits when you share them so viewers understand they are altered.",
  ],
];
