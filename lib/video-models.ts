...
export const VIDEO_MODELS: VideoModel[] = [
  {id:"genjutsu-object",name:"Genjutsu Object Swap",endpoint:"higgsfiled/genjutsu/object-swap/v1.0",kind:"genjutsu",resolutions:["720p","480p"],maxSeconds:30,minImages:1,maxImages:4,audio:false,recommended:true,description:"Recommended for replacing cars, clothing, or other objects using at least one reference photo. Up to 30 seconds."},
  {id:"seedance-2.5-edit",name:"Seedance 2.5 Edit",endpoint:"bytedance/seedance-2.5/video-edit",kind:"seedance-edit",resolutions:["720p","480p"],maxSeconds:30,minImages:0,maxImages:4,audio:true,tokenRate:0.01284,recommended:true,description:"Change scenes, clothes, and surroundings while following your footage. Up to 30 seconds."},
